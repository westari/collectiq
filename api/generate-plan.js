...
CRITICAL: Use age and size to calibrate intensity and drill selection.
- 13 or under: Lower intensity, fundamentals first, no advanced contact drills.
- Younger players (14-15): Build foundation, technique-heavy, moderate conditioning.
- Older players (16-18+): Higher intensity, more contact, advanced moves.
- Smaller guards (under 5'10"): More speed/quickness/handle work, finishing through contact.
- Taller players (6'2"+): Footwork, post moves, perimeter skills if guards.
- Heavier players: Conditioning matters more, agility is the priority.`;
  }
...
FACILITIES: ${Array.isArray(access) ? access.join(', ') : access}${physicalSection}${skillSection}
...
6. Match drill intensity to the player's age and size from PHYSICAL PROFILE
7. CRITICAL: Day "focus" must be SHORT (1-3 words max). Examples: "Ball Handling", "Defense", "Left Hand", "Shooting", "Finishing". NEVER use long descriptive titles like "On-ball defense fundamentals + weak-hand paint finishes".
8. coachSummary.assessment should sound like Coach X talking directly to the player, 2-3 sentences, referencing what was seen on film if available
